...
introduction = """
    In this project we will develop and deploy a web application to a cloud service making it accessable to the public. The projects 
    tasks include opening accounts on github and render.com. Git repositary with README.md and gitignore files will be created. 
